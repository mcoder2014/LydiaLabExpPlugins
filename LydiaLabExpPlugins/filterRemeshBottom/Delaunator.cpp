...
delaunator::Delaunator::Delaunator(const std::vector<double> &in_coords)
    : coords(in_coords),
      triangles(),
      halfedges(),
      hull_prev(),
...
std::size_t delaunator::Delaunator::hash_key(const double x, const double y) const {
...
std::size_t delaunator::Delaunator::add_triangle(std::size_t i0, std::size_t i1, std::size_t i2, std::size_t a, std::size_t b, std::size_t c) {
...
void delaunator::Delaunator::link(std::size_t a, std::size_t b) {
...
std::pair<double, double> delaunator::circumcenter(const double ax, const double ay, const double bx, const double by, const double cx, const double cy) {
    const double dx = bx - ax;
    const double dy = by - ay;
    const double ex = cx - ax;
    const double ey = cy - ay;
